...
**Note: You should get a warning about one piece dropped. What happens to the name in Row 49, which contains two dashes? It didn't save the 3rd part of the name.
...
gasol_hookshot_month <- gasol_hookshots %>% 
  count(month)
